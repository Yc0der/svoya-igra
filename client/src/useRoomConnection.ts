    ...
    function connect(): void {
      ...
      ws.addEventListener('message', (event) => {
        ...
        if (message.type === 'joined') {
          ...
          // нужно стереть, а не оставить висеть. Reconnect по токену не
          // трогает ни один из refs, так что сюда не заходит вовсе — само
          // переподключение не должно ничего чистить.
