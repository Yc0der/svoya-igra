...
// возникает»). 270мс подобраны на настоящем табло (живая проверка
// 2026-08-21): первые 200мс были выбраны сравнением на мониторе
// разработчика и на телевизоре с трёх метров оказались чуть резковаты —
// контраст и угловой размер букв там другие. Значение по-прежнему
// ВРЕМЕННО настраивается из админки (раздел
...
// вызовы).
export const TEXT_REVEAL_FADE_MS = 270;
